  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="proteinasModalTitle"><h4><b>Ya estás casi listo, esto es lo que vas a recibir:</b></h4></h5>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
           <p><b>Cada semana, recibe en la comodidad de tu casa u oficina una #NutriBox con el siguiente contenido:</b></p>
            ...
            <i style="float:left" class="material-icons">done</i>&nbsp;Cesta de productos frescos y de calidad, seleccionados cuidadosamente pensando en tu alimentación y salud.<br><br>

            <i style="float:left" class="material-icons">done</i>&nbsp;Ahorra al recibir lo necesario para preparar todos tus alimentos de acuerdo al plan.
          </div>

          <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
            <p><b>"Nuestra #NutriBox está preparada para cumplir con tu plan nutricional para una semana con 4 comidas diarias: Desayuno, Merienda de la mañana, Almuerzo y Cena."</b></p>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p><b>José Rodriguez, V.- 11.307.497</b></p>

        <p><b>0105-0699-9316-9905-5475 | Banco Mercantil</b></p>
...
<!-- Modal -->
<div class="modal fade" id="correoConfModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Por favor verifica tu correo electrónico.</h5>
      </div>
      <div class="modal-body">

        <p>Hemos enviado un correo electrónico para confirmar tu registro en Ceresfresh. <b>Haz click</b> en el enlace proporcionado para <b>activar tu cuenta</b>.</p>

      </div>
      <div class="modal-footer">
        <button style="background: #36434a; color:white" id="btnAceptarInicio" type="button" class="btn btn-secondary" data-dismiss="modal">Aceptar</button>
      </div>
    </div>
  </div>
</div>
...
<br>
    <div style="margin-bottom:15%;" class="container text-center animated fadeIn">
      ...
      <h2 id='texto_comenzar'>Comenzar con el Registro</h2>
      <br>
  ...
  <!-- Inicio RegisterRegister!-->
        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
	           <img  class="img-fluid " src="<?php echo base_url(); ?>img/bowl2.png" class="d-block w-100" alt="...">
        </div>
  <!-- Inicio RegisterRegister Email!-->
        <div class="col-md-4 col-sm-12 col-xs-12" id='register1'>

            <input type="hidden" name="nombre_proveedor" id='nombre_proveedor' value="sistema cerefresh">
              <input type="hidden" name="correo_session" id='correo_session' value="<?php echo $correo_session?>">
              <br>  <br>  <br>

           <!-- <div class="row">

              <div class="col-12">
                <input class='facebook_reg' onclick="" name="gmail_reg" value="&nbsp;Continuar con Facebook&nbsp;"  type="button"><br>
              </div>
              </div>
              <br>
              ...
              <div class="row" style="">
                ...
                <input style="background: #b83a2c;" class='gmail_reg' onclick="" name="facebook_reg" value="&nbsp;Continuar con google&nbsp;"  type="button"><br>
              </div>
            </div>!-->
              <p><b>NOTA:</b> Si ya te encuentras <b>Registrado</b> puedes iniciar sesión <b>Aquí</b></p>
              <hr>
              <div class='row'>
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <!--<p style="text-align:left">Correo </p>!-->
                  <input class="form-control requerir" type="email" name="correo_inicio" id='correo_inicio' placeholder="Ingresa tu correo" required><br>
                </div>
              </div>

            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <input style="background:#7dbe41" class="continuar_reg"  id='continuar'  name="registrar" value="&nbsp;Continuar&nbsp;"  type="button">
              </div>
              <br><br>
            ...
            <div class="col-md-4 col-sm-12 col-xs-12" id='register2'>
                ...
                <div class="row">
                  ...
                  <br>
                      <div class="row" style="">
                  <div class="col-12">
                    <span class='nunita'>Crea tu cuenta CeresFresh o Inicia Sesión.</span> <br><br>
                    <input class="form-control requerir" type="email" name="correo" id='correo' value  required>
                  </div>
                </div>
                  <hr>
                  <div class='row'>
                  <div class="col-md-12 col-sm-12 col-xs-12">
                      <!--<p style="text-align:left">Correo </p>!-->
                      <input class="form-control requerir" type="password" name="clave" id='clave' placeholder="Ingresa una contraseña" required>
                      <span style="color:red;" id="errorClave"></span>
                      <br>
        ...
        <div class='col-md-2 col-sm-12 col-lg-12'>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
          ...
          <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
            ...
            <p class="lato"><b>Regístrate</b></p>
            <p><b>Primero Debes completar los pasos de registro Aquí</b>. Al registrarte prepararemos para ti y tu familia un plan nutricional saludable.</p>
          </div>
          <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
            
            <i class="material-icons">attach_money</i>
            <p class="lato"><b>Delicias a tu alcance</b></p>
            <p>Una vez completado el proceso de <b>Registro</b> y haber <b>cancelado</b> tu pedido recibirás tu <b>Cesta de productos frescos y de calidad</b>.</p>
          </div>
          <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
            
            <i class="material-icons">local_shipping</i>
            <p class="lato"><b>Recibe tu #NutriBox</b></p>
            <p>Cada semana, recibe en la comodidad de tu casa u oficina una <b>#NutriBox</b>. Ahorra al recibir lo necesario para tu plan.</p>
          </div>

          <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
            
            <i class="material-icons">restaurant_menu</i>
            <p class="lato"><b>Disfruta</b></p>
            <p>Disfruta saludablemente de cada plato siguiendo las recomendaciones nutricionales del plan. <b>#SomosCeres #SomosFresh</b>.</p>
          </div>
...
<div style="display:none;" id="resumenCDP" class="col-md-4 col-sm-12 col-lg-4 col-xs-12">
  <div class="card">
    <div class="card-body">
      ...
      <div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <p>El precio de la <b>#Nutri<span style="color: #7dbe41;">Box</span></b> puede variar según el plan nutricional que le será asignado.</p>
          <div class="row">
            ...
            <div class="col-6 text-left">
              ...
              <p><b>$<?php echo $precio_dolares; ?></b></p>
              <p><b>Bs <?php echo $precio_bs; ?></b></p>
              <p>1</p>
            </div>
          </div>
          <hr>
  ...
  <form class="form-group" id='form_direccion' action="" data-toggle="validator" method="post">
    ...
    <div class='row'>
      <div class='col-12 labeL_formulario' >
        <p >Dirección</p>
        <textarea class="form-control requerir" type="text"  id="direccion_reg" name="direccion_reg" placeholder="Ingrese su dirección" required>  </textarea><br>
      </div>
      <br>
    </div>
...
<script src="<?php echo base_url(); ?>js/registro.js" type="text/javascript"></script>
