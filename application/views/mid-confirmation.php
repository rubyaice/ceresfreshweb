...
<!-- Modal -->
<div class="modal fade" id="misGustosModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle"><b>Queremos Consentirte</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>Déjanos conocer cuáles son tus gustos y preferencias para brindarte la mejor selección en tus comidas.</p>
      </div>
      <div class="modal-footer">
        <button style="background: #36434a; color:white" type="button" class="btn" data-dismiss="modal">No, gracias</button>
        <button style="background: #36434a; color:white" id="btnMisGustos" type="button" class="btn">&nbsp;Aceptar&nbsp;</button>
      </div>
    </div>
  </div>
</div>
...
<div class="Middle Confirmation MaxWidth ">
            ...
            <div class="Left">
                <?php
                            ...
                            <div class="HeaderGroup">Direccion de envío</div>
                                ...
                                <hr>
                                <div>
                                    <p><b>NOTA:</b> Descubre el <b>Plan Nutricional</b> que hemos preparado para ti y elige tus preferencias en comidas en el área de <b>"Mis Gustos"</b>.</p>
    ...
    <script src="<?php echo base_url(); ?>js/confirmation.js" type="text/javascript"></script>
