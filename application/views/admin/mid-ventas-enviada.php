...
<div id="modalEstatusPago" class="modal">
    <div class="modal-content">
      <h4>Pedido entregado en Destino</h4>
      <p>¿Deséa Mover este pedido a Entregado en destino?</p>
      

        <input type="hidden" id="code" name="code">
        <input type="hidden" id="estatus" name="estatus" value="8">
...
<div id="modalEstatusFallo" class="modal">
    <div class="modal-content">
      <h4>Error!!</h4>
      <p>Ocurrió un <b>Error</b> durante la Modificación del estatus, por favor intente más tarde.</p>
...
<main>
    <div class="container main">
        <h4>Pedidos Enviados a destino (PASO 4)</h4>
        <div class="row">
            <div class="col-12">
...
<script src="<?php echo base_url(); ?>js/admin/enviado.js"></script>