...
<div id="modalEstatusPago" class="modal">
    <div class="modal-content">
      <h4>Pedido enviado a destino</h4>
      <p>¿Deséa Mover este pedido a Enviado a destino?</p>
      

        <input type="hidden" id="code" name="code">
        <input type="hidden" id="estatus" name="estatus" value="7">
...
<main>
    <div class="container main">
        <h4>Pedidos pendientes por Enviar (PASO 3)</h4>
        <div class="row">
            <div class="col-12">
...
<script src="<?php echo base_url(); ?>js/admin/procesada.js"></script>