<main>
    ...
    <h4>Pagos Rechazados (Transacciones fallidas de usuario)</h4>
    <div class="row">
            <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-12" id="Devoluciones-container">
                </div>
            </div>
        </div>
...
<script src="<?php echo base_url(); ?>js/admin/devoluciones.js"></script>