...
<div id="modalEstatusFallo" class="modal">
    <div class="modal-content">
      <h4>Error!!</h4>
      <p>Ocurrió un <b>Error</b> durante la Autorización del Pago, por favor intente más tarde.</p>
...
<main>
    <div class="container main">
        ...
        <div class="lista">
            ...
            <div class="row">
                <div class="col-12" id="usuarios-gustos-container">
...
<div id="modalAlimentosUsuario" class="modal container-fluid">
    <div class="modal-content" id="modal-Cerrar-Pedido">
    </div>
    <div class="modal-footer">
...
<script src="<?php echo base_url(); ?>js/admin/administrar_gustos.js"></script>