...
<div id="modalEstatusPago" class="modal">
    <div class="modal-content">
      <h4>Pedido listo para Enviar</h4>
      <p>¿Deséa Mover este pedido a listos para enviar?</p>
      

        <input type="hidden" id="code" name="code">
        <input type="hidden" id="estatus" name="estatus" value="4">
...
<main>
    <div class="container main">
        <h4>Pedidos pendientes por Preparar (PASO 2)</h4>
        <div class="row">
            <div class="col-12">
...
<script src="<?php echo base_url(); ?>js/admin/ventas.js"></script>