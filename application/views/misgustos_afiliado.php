  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="container">
        <p><b>Por favor desmarca los alimentos que no quisieras que incluyamos en tu #Nutribox.</b></p>
        <?php if($alimentos_usuario_lacteos == null): ?>
            <p>Su plan no admite lacteos</p>
        <?php endif; ?>
...
<div class="modal fade bd-example-modal-lg" id="carnicosModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Selección de Carnícos o Proteínas</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<br>
    ...
    <input type="hidden" id="id_afiliacion" value="<?php echo $id_afiliacion; ?>">
            ...
            <div class="col-md-4 col-lg-4 col-ms-12 col-xs-12">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">En esta sección podrás elegir qué Lácteos prefieres que incluyamos en tu #NutriBox.</p>
            ...
            <div class="col-md-4 col-lg-4 col-ms-12 col-xs-12">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">En esta sección podrás elegir qué Vegetales prefieres que incluyamos en tu #NutriBox.</p>
            ...
            <div class="col-md-4 col-lg-4 col-ms-12 col-xs-12">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">En esta sección podrás elegir qué Frutas prefieres que incluyamos en tu #NutriBox.</p>
        ...
        <div class="row">
            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">En esta sección podrás elegir qué Carbohidratos prefieres que incluyamos en tu #NutriBox.</p>
            ...
            <div class="col-md-4 col-lg-4 col-ms-12 col-xs-12">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><b>Carnícos o Proteínas</b></h5>
                        <p class="card-text">En esta sección podrás elegir qué Carnícos o Proteínas prefieres que incluyamos en tu #NutriBox.</p>
            ...
            <div class="col-md-4 col-lg-4 col-ms-12 col-xs-12">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">En esta sección podrás elegir qué Grasas prefieres que incluyamos en tu #NutriBox.</p>
...
<script src="<?php echo base_url(); ?>js/mis_gustos_afiliado.js" type="text/javascript"></script>