...
class Suscripcion_usuario_model extends CI_Model {
  ...
  public function suscribir_usuario($correo, $plan_suscrip, $num_afiliacion, $nombre, $apellido, $cedula, $edad, $sexo, $peso, $estatura, $act_fisica, $condicion_esp, $direccion_envio, $estatus, $tipo_transaccion, $num_transaccion, $precio_plan, $banco_emisor, $banco_receptor, $code_orden, $fecha)
  {
    ...
    //insercion en la tabla de MA_SUSCRIPCION del usuario que se registro para que este un registro del estado del usuario
