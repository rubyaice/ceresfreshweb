...
function guardarGustoUs(){
    ...
    var activacion = 1;
    var id_afiliacion = document.getElementById('id_afiliacion').value;

    $.ajax({

        url: base_url+"index.php/Misgustos/guardar_gusto_afiliado",
        type: 'POST',
        global: false,
        data: {
...
$('html').on('click','.checkActivo',function(event){
      ...
      var cod_alimento = $(this).attr('data-alimento');
       ...
       $.ajax({
           url: base_url+"index.php/Misgustos/agregar_gusto_afiliado",
           global: false,
           type: 'POST',
           data: {
