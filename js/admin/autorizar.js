...
//metodo para mostrar ventas de admin
...
function PreguntaEstatus($Code, $num_registro_usuario)
{
    var code = document.getElementById('code').value = $Code;
    var num_registro = document.getElementById('num_registro').value = $num_registro_usuario;
...
{   
    ...
    var estatus = $('input[name=estatus]:checked', '#formularioEstatus').val();
    ...
    $.ajax({
        url:base_url+"index.php/admin/Pedidos/EstatusPago/aprobar_rechazar_pago",
        global: false,
        type: 'GET',
        data: {
