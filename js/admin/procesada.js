...
{
    $.ajax({
        url: base_url+"index.php/admin/ventas/GetSalesListProcesado",
        global: false,
        type: 'GET',
        data: {Pag: 1},
...
$("html").on("change","#OrderDate",function(){
    ...
    delayTimer = setTimeout(function() {
        ...
        $Date=$('#OrderDate').val();
        $.ajax({
            url: base_url+"index.php/admin/ventas/GetSalesList",
            global: false,
            type: 'GET',
...
{   
    ...
    $.ajax({
        url:base_url+"index.php/admin/Pedidos/EstatusPago/pasar_a_enviados",
        global: false,
        type: 'GET',
        data: {
